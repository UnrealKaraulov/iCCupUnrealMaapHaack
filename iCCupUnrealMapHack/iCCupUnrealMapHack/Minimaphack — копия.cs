        ...
        private void MinihackTimer_Tick(object sender, EventArgs e)
        {
            ...
            //  try
            {
                if (war3processmemory != null)
                {
                    ...
                    float mapleft = war3processmemory.ReadFloat(MapOffset + 1232) - 600.0f;
                    float maptop = war3processmemory.ReadFloat(MapOffset + 1236) + 450;
                    float mapright = war3processmemory.ReadFloat(MapOffset + 1240) + 800.0f;
                    float mapbot = war3processmemory.ReadFloat(MapOffset + 1228) - 400;
                    ...
                    // try
                    {
                        if (null == maphackprofile.orgminimap)
                        {
                            ...
                            maphackprofile.orgminimap = ReadMapMinimap;
                        }
                    }
                    /*catch
                    {
                    ...
                    if (maphackprofile.orgminimap != null)
                    {
                        ...
                        float originalwidth = maphackprofile.orgminimap.Width;
                        float originalheight = maphackprofile.orgminimap.Height;

                        float imagescalex = Width / originalwidth;
                        float imagescaley = Height / originalheight;


                        Bitmap TempBmp = new Bitmap(maphackprofile.orgminimap, this.Width, this.Height);
                                ...
                                // try
                                {
                                    ...
                                    switch (CurrentDrawType)
                                    {
                                        case 0:
                                            ...
                                            {
                                                g.FillRectangle(new SolidBrush(Color.White), (CurrentUnitMiniMapX - 2) * imagescalex, (CurrentUnitMiniMapY - 2) * imagescaley, 4 * imagescalex, 4 * imagescaley);
                                            }
                                            else
                                                g.FillEllipse(new SolidBrush(Color.White), (CurrentUnitMiniMapX - 4) * imagescalex, (CurrentUnitMiniMapY - 4) * imagescaley, 8 * imagescalex, 8 * imagescaley);
                                            break;
                                        case 1:
                                            if (!MinimapColored)
                                            {
                                                if (IsCurrentUnitHero == 0)
                                                {
                                                    if (IsCurrentUnitTower)
                                                        g.FillRectangle(new SolidBrush(Color.Aqua), (CurrentUnitMiniMapX - 3) * imagescalex, (CurrentUnitMiniMapY - 3) * imagescaley, 6 * imagescalex, 6 * imagescaley);
                                                    else
                                                        g.FillRectangle(new SolidBrush(Color.Aqua), (CurrentUnitMiniMapX - 2) * imagescalex, (CurrentUnitMiniMapY - 2) * imagescaley, 4 * imagescalex, 4 * imagescaley);
                                                }
                                                else
                                                    g.FillEllipse(new SolidBrush(Color.Aqua), (CurrentUnitMiniMapX - 4) * imagescalex, (CurrentUnitMiniMapY - 4) * imagescaley, 8 * imagescalex, 8 * imagescaley);
                                            }
                                            else
                                            {
                                                ...
                                                if (IsCurrentUnitHero == 0)
                                                {
                                                    ...
                                                    {
                                                        if (IsCurrentUnitTower)
                                                            g.FillRectangle(new SolidBrush(Color.Red), (CurrentUnitMiniMapX - 3) * imagescalex, (CurrentUnitMiniMapY - 3) * imagescaley, 6 * imagescalex, 6 * imagescaley);
                                                        else
                                                            g.FillRectangle(new SolidBrush(Color.Red), (CurrentUnitMiniMapX - 2) * imagescalex, (CurrentUnitMiniMapY - 2) * imagescaley, 4 * imagescalex, 4 * imagescaley);
                                                    }
                                                    else
                                                    {
                                                        if (IsCurrentUnitTower)
                                                            g.FillRectangle(new SolidBrush(Color.Green), (CurrentUnitMiniMapX - 3) * imagescalex, (CurrentUnitMiniMapY - 3) * imagescaley, 6 * imagescalex, 6 * imagescaley);
                                                        else
                                                            g.FillRectangle(new SolidBrush(Color.Green), (CurrentUnitMiniMapX - 2) * imagescalex, (CurrentUnitMiniMapY - 2) * imagescaley, 4 * imagescalex, 4 * imagescaley);
                                                    }
                                                }
                                                else
                                                    g.FillEllipse(new SolidBrush(herocolor), (CurrentUnitMiniMapX - 4) * imagescalex, (CurrentUnitMiniMapY - 4) * imagescaley, 8 * imagescalex, 8 * imagescaley);
                                        ...
                                        case 2:
                                            if (!MinimapColored)
                                            {
                                                if (IsCurrentUnitHero == 0)
                                                {
                                                    ...
                                                    g.FillEllipse(new SolidBrush(Color.Red), (CurrentUnitMiniMapX - 4) * imagescalex, (CurrentUnitMiniMapY - 4) * imagescaley, 8 * imagescalex, 8 * imagescaley);
                                            }
                                            else
                                            {
                                                Color herocolor = GetColorByPlayerSlot(CurrentUnitPlayerSlot);
                                        ...
                                        case 3:
                                            ...
                                            break;
                                        case 4:
                                            g.FillRectangle(new SolidBrush(Color.FromArgb(0, 0, 50)), (CurrentUnitMiniMapX - 2) * imagescalex, (CurrentUnitMiniMapY - 2) * imagescaley, 4 * imagescalex, 4 * imagescaley);
                                            break;
                                        case 5:
                                            ...
                                            for (int objid = 0; objid < maphackprofile.units.Length; objid++)
                                            {
                                                if (maphackprofile.units[objid].name == CurrentUnitClassString)
                                                {
                                                    if (maphackprofile.units[objid].framecount > 1)
                                                    {
                                                        ...
                                                        float imageoffsetx = maphackprofile.units[objid].frames[maphackprofile.units[objid].frameid].Width * maphackprofile.DefaultIconScale / 2.0f;
                                                        float imageoffsety = maphackprofile.units[objid].frames[maphackprofile.units[objid].frameid].Height * maphackprofile.DefaultIconScale / 2.0f;

                                                        float drawoffsetx = CurrentUnitMiniMapX * imagescalex;
                                                        drawoffsetx -= imageoffsetx;
                                                        float drawoffsety = CurrentUnitMiniMapY * imagescaley;
                                                    ...
                                                    {
                                                        float imageoffsetx = maphackprofile.units[objid].image.Width * maphackprofile.DefaultIconScale / 2.0f;
                                                        float imageoffsety = maphackprofile.units[objid].image.Height * maphackprofile.DefaultIconScale / 2.0f;
                                        ...
                                        case 0:
                                            ...
                                            else
                                            {
                                                if (maphackprofile.IsAnimatedMinihackHeroes)
                                                {
                                                    ...
                                                    float imageoffsetx = PlayerHeroBitmap.Width * maphackprofile.DefaultIconScale / 2.0f;
                                                    float imageoffsety = PlayerHeroBitmap.Height * maphackprofile.DefaultIconScale / 2.0f;
                                                    ...
                                                    g.FillEllipse(new SolidBrush(Color.White), (CurrentUnitMiniMapX - 5) * imagescalex, (CurrentUnitMiniMapY - 5) * imagescaley, 10 * imagescalex, 10 * imagescaley);
                                            }
                                            break;
                                        case 1:
                                            if (!MinimapColored)
                                            {
                                                ...
                                                else
                                                {
                                                    if (maphackprofile.IsAnimatedMinihackHeroes)
                                                    {
                                                        ...
                                                        g.FillEllipse(new SolidBrush(Color.Aqua), (CurrentUnitMiniMapX - 5) * imagescalex, (CurrentUnitMiniMapY - 5) * imagescaley, 10 * imagescalex, 10 * imagescaley);
                                            ...
                                            else
                                            {
                                                ...
                                                else
                                                {
                                                    if (maphackprofile.IsAnimatedMinihackHeroes)
                                                    {
                                                        ...
                                                        g.FillEllipse(new SolidBrush(herocolor), (CurrentUnitMiniMapX - 5) * imagescalex, (CurrentUnitMiniMapY - 5) * imagescaley, 10 * imagescalex, 10 * imagescaley);
                                                }
                                            }
                                            break;
                                        case 2:
                                            if (!MinimapColored)
                                            {
                                                ...
                                                else
                                                {
                                                    if (maphackprofile.IsAnimatedMinihackHeroes)
                                                    {
                                                        ...
                                                        g.FillEllipse(new SolidBrush(Color.Red), (CurrentUnitMiniMapX - 5) * imagescalex, (CurrentUnitMiniMapY - 5) * imagescaley, 10 * imagescalex, 10 * imagescaley);
                                                }
                                            }
                                            else
                                            {
                                        ...
                                        for (int objid = 0; objid < maphackprofile.items.Length; objid++)
                                        {
                                            if (maphackprofile.items[objid].name == CurrentItemStringId)
                                            {
                                                if (maphackprofile.items[objid].framecount > 1)
                                                {
                                                    ...
                                                    float imageoffsetx = maphackprofile.items[objid].frames[maphackprofile.items[objid].frameid].Width * maphackprofile.DefaultIconScale / 2.0f;
                                                    float imageoffsety = maphackprofile.items[objid].frames[maphackprofile.items[objid].frameid].Height * maphackprofile.DefaultIconScale / 2.0f;

                                                    float drawoffsetx = CurrentItemMiniMapX * imagescalex;
                                                    drawoffsetx -= imageoffsetx;
                                                    float drawoffsety = CurrentItemMiniMapY * imagescaley;
                                                    drawoffsety -= imageoffsety;
                                                ...
                                                {
                                                    float imageoffsetx = maphackprofile.items[objid].image.Width * maphackprofile.DefaultIconScale / 2.0f;
                                                    float imageoffsety = maphackprofile.items[objid].image.Height * maphackprofile.DefaultIconScale / 2.0f;
